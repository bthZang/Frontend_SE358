...
const dropdownTheme: CustomFlowbiteTheme["dropdown"] = {
    ...
    floating: {
        ...
        base: "z-10 w-fit bg-white rounded divide-y divide-secondary-100 shadow focus:outline-none",
        content: "py-1 text-sm text-secondary-700  bg-white",
        divider: "my-1 h-px bg-secondary-100 ",
        header: "block py-2 px-4 text-sm text-secondary-700",
        hidden: "invisible opacity-0",
        item: {
            container: " bg-white",
            base: "flex flex-row items-center justify-between  bg-white py-2 px-4 text-sm text-secondary-800 cursor-pointer w-full hover:bg-secondary-100 focus:bg-secondary-100 ",
        ...
        target: " relative w-full flex justify-start border-2 border-surface-grey02 text-ellipsis flex bg-white text-secondary-950 transition duration-200 enabled:hover:bg-primary-200 enabled:active:bg-primary-300",
    },
    inlineWrapper: "flex  bg-white  w-full items-center justify-between",
};
